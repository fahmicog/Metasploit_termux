...
curl -LO https://raw.githubusercontent.com/fahmicog/Metasploit_termux/master/database.yml
...
cd ${PREFIX}/bin && curl -LO https://fahmicog.github.io/files/msfconsole && chmod +x msfconsole
